...
const directions = [
  'You can login at glare.fm at anytime, but to listen to music, you\'ll have to find someone that\'s already unlocked it.',
  'Unlocking requires being physically near someone with an activated glare.fm account so its necessary to allow geolocation.',
  'Once activated you’ll have four songs to hear, and you can unlock two more each time you share it with someone else.',
  'You\'ll also be able to follow where on earth the albums traveled, and track your personal influence on its spread.',
]
